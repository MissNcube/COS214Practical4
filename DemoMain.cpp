...
int main()
{
    ...
    cout << std::endl<<RESET<<endl;
    Truck * truck =  riceField->buyTruck("DeliveryTruck", 100, 1, 200);cout << endl;
    Truck* truck2 = wheatField->buyTruck("FertilizerTruck",468,55,200);cout << endl;
    Truck* truck3 = maizeField->buyTruck("FertilizerTruck",468,20,200);cout << endl;

    DeliveryTruck* dtk = dynamic_cast<DeliveryTruck*>(truck);cout << endl;
    FertilizerTruck* ftk = dynamic_cast<FertilizerTruck*>(truck2);cout << endl;
    FertilizerTruck* ftk2 = dynamic_cast<FertilizerTruck*>(truck3);cout << endl;

    cout << RESET <<endl;
    riceField->notifyTrucks();
    cout << endl;
    std::cout<<"Count of delivery truck for rice field : "<<dtk->getCallCounter()<<std::endl<<endl;
    wheatField->notifyTrucks();
    std::cout<<"Count of fertilizer truck for wheat field: "<<ftk->getCallCounter()<<std::endl<<endl;
    maizeField->notifyTrucks();
    std::cout<<"Count of fertilizer truck for maize field: "<<ftk2->getCallCounter()<<std::endl<<RESET<<endl;

    typewriterEffect( BLUE UNDERLINE "\n=== NOTIFYING A SPECIFIC TRUCK ===\n", 40);
    cout <<RESET<< endl;
    maizeField->notifyTruck(ftk2);

    riceField->currStorageCap();cout<<endl;  
    riceField->currSoilState();cout<<endl; 

    wheatField->currStorageCap();cout<<endl;   
    wheatField->currSoilState();cout<<endl;  
    ...
    cout << RESET <<endl;
    mainFarm->addTruck(dtk);cout<<endl;
    mainFarm->addTruck(ftk);cout<<endl;
    mainFarm->addTruck(ftk2);cout<<endl;
...
//=====================================================================================
    ...
    std::cout<<"Updating the temperature sensors of the farm  to : "<<mainFarm->getSensorData("Temperature")<<RESET<<endl<<std::endl;
    ...
    Fertilizer *ftl = new Fertilizer(cornField);cout<<endl;
    cout << GREEN;
    ftl->increaseProduction();cout<<endl;
    cout <<RESET;

    int newYield = ftl->harvest();cout<<endl;
    std::cout << "Increased Yield: " << newYield << std::endl;

    ExtraBarn *barn = new ExtraBarn(cornField, 50);cout<<endl;
    barn->add();cout<<endl;
    int cap = barn->getLeftoverCapacity();
    std::cout << "Total increased capacity after an extra barn: " << RED << cap <<RESET<<endl << std::endl;
